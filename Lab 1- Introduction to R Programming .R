...
install.packages("gmodels") # To make cross tables
##### R data structures --------------------
...
# To determine the class of a vector you may use any of these
class (subject_name)
typeof (subject_name)
str (subject_name)

# Observe the Console and Global Environment wind0w as you run these statements
